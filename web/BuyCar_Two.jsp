    	...
    	<div class="two_bg">
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <c:forEach items="${sessionScope.car}" var="car" varStatus="status">
                    <tr <c:if test="${(status.index)%2 ne 0}"> class="car_tr" </c:if> >
                        ...
                        <td align="center">${car.getKey().description}</td>
                        <td align="center">${car.getValue()}</td>
                        <td align="center" style="color:#ff4e00;">￥${car.getKey().price * car.getValue()}</td>
              ...
              <tr>
                <td colspan="5" align="right" style="font-family:'Microsoft YaHei';">
                    商品总价：￥<span name="car_count_price"></span>； 返还积分 56R
                </td>
              </tr>
            </table>
            ...
            <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="395">${sessionScope.user.loginName}</td>
            ...
            <div class="two_t">
                ...
                <table id="address_table" border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
                    <%--<tr>
                        <td class="p_td" width="160">
                            地址名称<input type="radio" name="address" value="" />
                        </td>
                        <td>
                            地址详情信息
                        </td>
                    ...
                    <tr>
                        <form action="/address" id="addAddressFrm" method="post">
                            <td class="p_td" width="160">
                                <input type="hidden" name="opr" value="addAddress"/>
                                新地址<input type="radio" name="addressId" value="" />
                            </td>
                            <td>
                                地址:<input type="text" id="addressInfo" name="address" value="" class="add_ipt" />
                                备注:<input type="text" id="remake" name="remake" value="" class="add_ipt" />
                            </td>
                        </form>
                    </tr>
                </table>
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr>
                <td align="right">
                    ...
                    商品总价: <font color="#ff4e00">￥<span name="car_count_price"></span></font>  + 配送费用: <font color="#ff4e00">￥15.00</font>
                </td>
              </tr>
              <tr height="70">
                <td align="right">
                	<b style="font-size:14px;">应付款金额：<span style="font-size:22px; color:#ff4e00;">￥<span name="car_count_price_all"></span></span></b>
                </td>
              </tr>
              <tr height="70">
                <td align="right"><a onclick="doAddress();" href="javascript:void(0);"><img src="images/btn_sure.gif" /></a></td>
              </tr>
            </table>
            ...
            success:function (data) {
                $.each(data,function (index,obj) {
                    $("#address_table").append("<tr>\n" +
                        "                    <td class=\"p_td\" width=\"160\">\n" +
                        "                        "+obj.remark+"<input type=\"radio\" name=\"addressId\" value='"+obj.address+"' />\n" +
                        "                    </td>\n" +
                        "                    <td>\n" +
                        "                        "+obj.address+"\n" +
                        "                    </td>\n" +
    ...
    function doAddress() {
        if ($("input:radio:checked").val() == ""){
            $.ajax({
                url:"/address",
                type:"post",
                data:{opr:"addAddress",address:$("#addressInfo").val(),remake:$("#remake").val()},
                dataType:"text",
                success:function (data) {
                    addOrder($("#addressInfo").val());
                }
            });
        }else {
            addOrder($("input:radio:checked").val())
        }
        function addOrder(address) {
            $.ajax({
                url:"/order",
                type:"post",
                data:{opr:"addOrder",address:address,cost:$("span[name=car_count_price_all]").html()},
                dataType:"text",
                success:function (data) {
                    $(location).attr('href', '/BuyCar_Three.jsp');
                }
            });
        }
    }
