...
<div class="i_bg">
	<div class="postion">
        ...
        <c:forEach var="menu1" items="${menu}">
            <c:if test="${menu1.id eq product.categoryLevel1Id}"> ${menu1.name} > </c:if>
            <c:forEach var="menu2" items="${menu1.list}">
                <c:if test="${menu2.id eq product.categoryLevel2Id}"> ${menu2.name} > </c:if>
                <c:forEach var="menu3" items="${menu2.list}">
                    <c:if test="${menu3.id eq product.categoryLevel3Id}"> ${menu3.name} > </c:if>
                </c:forEach>
            </c:forEach>
        </c:forEach>
    	${product.name}</span>
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="images/p_big.jpg" title="Images" class="MagicZoom" id="MagicZoom"><img src="images/${product.fileName}" width="390" height="390" /></a></div>
        ...
        <div class="pro_des">
            ...
            <div class="des_join">
            	<div class="j_nums">
                	<input type="text" value="1" id="j_nums" name="num" class="n_ipt" />
                	<input type="hidden" value="${product.id}" name="proId" class="n_ipt" />
                    <input type="button" value="" onclick="addUpdate(jq(this));" class="n_btn_1" />
                    <input type="button" value="" onclick="jianUpdate(jq(this));" class="n_btn_2" />   
                </div>
                <span class="fl"><a onclick="addCartByParam(${product.id},$('#j_nums').val())"><img src="images/j_car.png" /></a></span>
            </div>            
        </div>    
    ...
    <div id="MyDiv" class="white_content">             
        <div class="white_d">
            ...
            <div class="notice_c">
                ...
                <table border="0" align="center" style="margin-top:50px;" cellspacing="0" cellpadding="0">
                  <tr valign="top">
                ...
                <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0">
                  <tr valign="top">
                    ...
                    <td>
                    	...
                    	购物车共有<span name="carNum"></span>种宝贝（<span name="proNum"></span>件） &nbsp; &nbsp; 合计：<font color="#ff4e00">￥</font><span name="car_count_price"></span>
                    </td>
                  </tr>
                  <tr height="50" valign="bottom">
                  	<td>&nbsp;</td>
                    <td><a href="#" class="b_sure">去购物车结算</a><a href="javascript:CloseDiv_1('MyDiv1','fade1')" class="b_buy">继续购物</a></td>
                  </tr>
                </table>
