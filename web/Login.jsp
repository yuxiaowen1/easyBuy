...
<div class="log_bg">	
	...
	<div class="login">
		...
		<div class="log_c">
        	<form action="userServlet" method="post" id="loginFrm">
                ...
                <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
                  ...
                  <tr height="60">
                    <td></td>
                    <td><input type="button" id="loginBtn" value="登录" class="log_btn" /></td>
                  </tr>
                  <tr height="60">
                      <td>&nbsp;</td>
...
<form action="/proCategoryServlet" method="post" id="loginSucFrm">
    <input type="hidden" name="opr" value="findAll" />
</form>
<script type="text/javascript">
    $(function () {
        $("#loginBtn").click(function () {
            $.ajax({
                url:"/userServlet",
                type:"post",
                data:$.param($("#loginFrm").find(":input").serializeArray()),
                dataType:"Text",
